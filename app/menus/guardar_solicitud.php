...
$sql_insertar = "INSERT INTO `solicitud` (`id`, `f_p`, `remitente`, `email`, `categoria`, `detalles`, `metodo`, `estado_solicitud`) VALUES (NULL, '$f_p', '$id_usuario', '$email', '$categoria', '$detalles', '$metodo', '1')";
