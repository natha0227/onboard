...
<body>
    ...
    <a href="../iniciar_sesion/cerrar_sesion.php"> 🡸 </a>
        ...
        <h2>Menú</h2>
        <p style="font-size: 16px; text-align: center;">Bienvenid@ asesor <?php echo $_SESSION['nickname']?>. </p> 
        <ul>
            <li><a href="#" onclick="cargarContenido('perfil.php')">Mi Perfil</a></li>
            <li><a href="#" onclick="cargarContenido('categorias_asesor.php')">Servicios</a></li>
            <li><a href="#" onclick="cargarContenido('solicitudes_pendientes.php')">Solicitudes</a></li>
